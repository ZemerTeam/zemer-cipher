...
if (process.env.GITHUB_OUTPUT) {
  ...
  set("cookie_suspect", authFailed.join(" "));
  set("action_count", String(out.dead.length + out.revived.length + out.resurrected.length + out.drift.length + out.sabrDead.length + out.sabrRevived.length + (out.conclusive ? 0 : 1) + (verdict.egressSuspect ? 1 : 0) + (authFailed.length ? 1 : 0)));
