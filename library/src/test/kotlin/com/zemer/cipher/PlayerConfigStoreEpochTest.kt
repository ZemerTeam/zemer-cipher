 ...
 * — the fix for playback staying pinned to a fallback client (a wrong-but-non-throwing signature)
 * until an app restart. A spurious bump would force needless WebView rebuilds; a missed bump would
 * reproduce the original stuck bug.
 */
